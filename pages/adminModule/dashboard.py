...
from pages.adminModule.patients import PatientManagement
from pages.adminModule.results import ResultsFrame
from pages.adminModule.settings import AdminSettings
from pages.adminModule.tests import TestManagement
from pages.adminModule.analytics import AnalyticsView
