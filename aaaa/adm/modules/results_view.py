...
class ResultsView(ctk.CTkFrame):
    ...
    def create_layout(self):
        ...
        # Create Treeview
        self.results_tree = ctk.CTkTreeview(
            self, 
    ...
    def create_context_menu(self):
        self.context_menu = ctk.Menu(self.results_tree, tearoff=0)
    ...
    def is_abnormal(self, result_value, reference_range):
        """Check if a result is outside the reference range."""
        try:
