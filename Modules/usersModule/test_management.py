...
class TestManagement(ttk.Frame):
    ...
    def setup_ui(self):
        ...
        # Left pane - Test Categories
        self.create_test_categories(content_frame)
        
        # Right pane - Test Details
        self.create_test_details(content_frame)

    # ... Additional methods for test management ...
